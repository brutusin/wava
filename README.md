...
The scheduler runs as a centralized process (`wava -s`). All comunication with it is performed by separated client processes started when invoking the other command options.  
