...
The scheduler runs as a centralized process (`wava -s`) and job submissions are performed by separate lightweight processes (`wava -r`) that serve as placeholders of the real jobs executed by the scheduler.   
